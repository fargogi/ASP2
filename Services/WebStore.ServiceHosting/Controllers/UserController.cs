...
using MyWebStore.DomainNew.DTO.User;
...
namespace WebStore.ServiceHosting.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task ReplaceClaimAsync([FromBody] ReplaceClaimDTO ClaimInfo) => await _userStore.ReplaceClaimAsync(ClaimInfo.User, ClaimInfo.OldClaim, ClaimInfo.NewClaim);

        [HttpPost("RemoveClaim")]
        public async Task RemoveClaimsAsync([FromBody] RemoveClaimsDTO ClaimInfo) => await _userStore.RemoveClaimsAsync(ClaimInfo.User, ClaimInfo.Claims);
        ...
        public async Task SetLockoutEndDateAsync([FromBody] SetLockoutDTO LocoutInfo) => await _userStore.SetLockoutEndDateAsync(LocoutInfo.User, LocoutInfo.LockoutEnd);
